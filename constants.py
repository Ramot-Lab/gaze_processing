...
SECONDS_TO_MICROSECOND_FACTOR = 1_000_000  # Conversion factor from seconds to microseconds
...
GAZE_HEATMAP_VIDEO_FILENAME_TEMPLATE = "{task_code}_{subject_name}_gaze_heatmap_video.mp4"
