...
if __name__=="__main__":
    ...
    group = "pwMS"
    panel = "i1"
    panel_path = "/Volumes/ramot/rotation_students/Noam_M/Sample_Data/pwMS/AG562/SDMT/Final_panels/combined_testable_0.jpg"
    data_path = "/Volumes/Labs/ramot/WIS_IDO/Results/Behavior"
    subject_data= ParticipantGazeDataManager(p_name, data_path, "SDMT", group)
    res = subject_data.annotate_gaze_events("model_based", panel)
    plot_gazeNet_fig(res)
